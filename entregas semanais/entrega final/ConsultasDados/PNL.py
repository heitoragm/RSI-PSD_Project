#bin/spark-submit --packages org.apache.spark:spark-sql-kafka-0-10_2.11:2.4.3 /home/rsi-psd-vm/Documents/rsi-psd-codes/psd/pratica-05/ConsultasDados/PNL.py localhost:9092 subscribe rsipsd_project
...
def processRow(row):
    print(row)
    row_data = { 'pnlsTabela' : row.__getitem__("count")}
